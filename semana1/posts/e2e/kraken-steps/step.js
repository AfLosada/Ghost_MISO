...
When('I set it up only form members', async function (){  
  await this.driver.$('[data-test-select="post-visibility"]').setValue("Members only")
  await this.driver.$('.settings-menu-header').click()
})
When('I see the published post in the posts in the members section of posts', async function (){  
  await this.driver.$('/html/body/div[2]/div/main/section/div/header/section/div[1]/div[2]/div[1]/span').click()
  await this.driver.$('[data-option-index="2"]').click()
})
