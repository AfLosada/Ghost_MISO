...
When('I add {kraken-string} to header with code injection', async function (content){
  await this.driver.$('[data-test-button="codeinjection"]').click()
  await this.driver.$('/html/body/div[2]/div/main/div[1]/div/div/div[2]/div/div[2]/form/div[1]/div/div/div[1]/textarea').setValue(content)
})
